...
export default function RecordingControls({ text, chapterTitle }: Props) {
  ...
  return (
    <div className="px-4 pb-3 flex flex-col gap-2 border-t border-gray-800 pt-2">
      ...
      <div className="flex items-center gap-2">
        ...
        <input
          ...
          className="flex-1 bg-gray-800 border border-gray-700 rounded px-2 py-1.5 text-xs text-gray-300 placeholder-gray-600 focus:outline-none focus:border-indigo-500 transition-colors"
        />
        ...
        <button
          ...
          disabled={saving}
          className="flex items-center gap-1.5 px-3 py-1.5 rounded bg-emerald-700 hover:bg-emerald-600 disabled:opacity-50 disabled:cursor-not-allowed transition-colors text-white text-xs font-medium"
